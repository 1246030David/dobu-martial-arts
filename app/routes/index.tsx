import mainimage from "~/assets/png/mainimage.png";
  ...
  return (
    <>
      <main className="">
        ...
        <div className=" flex place-content-evenly pt-10">
        ...
        <div className="md:flex md:justify-around">
          <Infocard
            ...
            bodytext="Our highly qualified martial arts instructors deliver classes in a
          ...
          <Infocard
            ...
            bodytext="The kids aren’t left out, daily after-school classes for children aged 5-15 covering all of the same disciplines available to adults."
          ></Infocard>
        </div>
        <div className="md:flex md:justify-around">
          <Infocard
            ...
            bodytext="As well as our gym and martial art facilities we also offer a sauna, steam room, shower and modern changing facilities allowing you to unwind after a hard workout."
          ></Infocard>

          <Infocard
            url="/contact"
            headline="Well equipped gym"
            bodytext="Our gym is equiped with a range of high quality equipment and free weights and is available throughout the day.
